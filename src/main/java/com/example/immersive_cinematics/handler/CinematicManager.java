...
import com.example.immersive_cinematics.script.LinearPath;
...
public class CinematicManager {
    ...
    // 保持向后兼容的方法
    public void startLinearMovement(Vec3 startPos, Vec3 endPos, double duration) {
        startDirectLinearMovement(startPos, endPos, duration);
    }
